...
<body>
    ...
    <div class="containergenero">
        ...
        <div class="mujer">
            <img class="imagenbotongenero" src="../img/2.png" alt="">
            <button class="btn btn-warning"><a href="./mujeres.php">Modelos Femeninos</a></button>

        </div>

        <div class="hombre">
            <img class="imagenbotongenero" src="../img/1 (2).png" alt="">
            <button class="btn btn-warning"><a href="./hombres.php">Modelos Masculinos</a></button>

        </div>
    </div>

    <footer class="footer prod" id="res">
        <div class="redes">
