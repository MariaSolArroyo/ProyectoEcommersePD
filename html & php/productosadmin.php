...
<body>
    ...
    <nav class="navbar">
        ...
        <div class="logosnav">
        <div class="agregar">
                <a href="agregar.html"><i class="bi bi-cloud-upload"></i></a>
            </div>
   ...
   <div class="row">
        ...
        while ($reg = mysqli_fetch_array($datos)) { ?>
            ...
            <img src="data:image/jpg;base64, <?php echo base64_encode($reg['imagen']) ?>" class="card-img-top w-100 imagencard" alt="...">
                ...
                <a href="verproductoadmin.php?id=<?php echo $reg['id']; ?>" class="btn btn-primary">Ver Producto</a>
